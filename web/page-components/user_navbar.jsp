    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                %>
                <li class="nav-item">
                    <a  href="../admin_dashboard.jsp" class="nav-link" aria-current="page"><span class="fa fa-square-h"></span> Home</a>
                </li>
                <li class="nav-item">
                ...
                %>
                <li class="nav-item">
                    <a  href="../doctor_dashboard.jsp" class="nav-link" aria-current="page"><span class="fa fa-square-h"></span> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../shared-views/view_doctor_detail.jsp?id=<%= doctor.getDoctorId() %>"><span class="fa fa-user-circle"></span> <%= doctor.getName()%></a>
                </li>
                <li class="nav-item">
                ...
                %>
                <li class="nav-item">
                    <a  href="../patient_dashboard.jsp" class="nav-link" aria-current="page"><span class="fa fa-square-h"></span> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../shared-views/view_patient_detail.jsp?id=<%= patient.getPatientId() %>"><span class="fa fa-user-circle"></span> <%= patient.getName()%></a>
                </li>
                <li class="nav-item">
