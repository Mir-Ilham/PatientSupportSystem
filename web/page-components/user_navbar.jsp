    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="doctor_dashboard.jsp"><span class="fa fa-user-circle"></span> <%= doctor.getName()%></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="patient_dashboard.jsp"><span class="fa fa-user-circle"></span> <%= patient.getName()%></a>
                </li>
                <li class="nav-item">
